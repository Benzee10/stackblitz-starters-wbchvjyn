...
const Header: React.FC<HeaderProps> = ({ groupInfo }) => {
  return (
    <div className="bg-[#3390ec] flex items-center p-3 sm:p-2.5 shadow-md z-10 safe-area-top">
      <div className="flex items-center flex-grow min-w-0">
        <button className="p-1 -ml-1 mr-2 touch-manipulation">
          <BackArrowIcon />
        </button>
        <div className="w-10 h-10 bg-white rounded-full mr-3 flex-shrink-0 flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#3390ec]" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="flex flex-col min-w-0 flex-grow">
          ...
          <span className="text-white text-sm opacity-75 truncate">{groupInfo.members}</span>
        </div>
      </div>
