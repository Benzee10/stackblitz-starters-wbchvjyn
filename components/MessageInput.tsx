...
const MessageInput: React.FC = () => {
  return (
    <div className="bg-white p-3 sm:p-3 flex items-center space-x-3 safe-area-bottom border-t border-gray-200">
      <div className="flex-grow flex items-center bg-gray-100 rounded-full px-4 py-3 shadow-sm min-h-[48px]">
        ...
        <input
          ...
          placeholder="Message"
          disabled
          className="bg-transparent flex-grow mx-3 text-gray-800 outline-none placeholder-gray-400 text-base"
        />
      ...
      <button className="bg-[#3390ec] w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg touch-manipulation active:bg-[#2b7cd6] transition-colors">
        <SendIcon />
      </button>
      <style>{`
